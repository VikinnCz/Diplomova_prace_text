...
Semestrální práce se zabývá problematikou \acs{MIR}. Popsánou v kapitole\ref{sec:MIR}.
 ...
 %TODO: Tohle nededává smysl sem jep otřeba něco doplnit předělat.
...
%TODO: Po sem to nejspíš nemá být a je to nějaký pozůstatek úvodu.

%TODO: I tahle spodní část je poměrně kostrbatá
...
%TODO: Informace o hlasitosti v češtině MPC-ELE2 přednáška 7 slide 64
  ...
  [50 150 250 350 450 570 700 840 1000 1170 1370 1600 1850 2150 2500 2900 3400 4000 4800 5800 7000 8500 10500 13500] %TODO: tohle je tu fuckin k čemu?
...
\subsection{Librosa}
    ...
    Pro tuto práci jsou důležitými funkcemi zejména Detekce tempa a taktů skladby, rozpoznání začátků tónů. Následně jsou v knihovně obsaženy nástroje pro vizualizaci získaných vlastností. Například zobrazerní spektrograma či grtafické zobrazení detekovaného taktu a tempa.

    Funkce pro detekci tempa a taktu skladby jsou v knihovně Librosa zapsány dle kódu
    %TODO: Vložit a správně odkázat na kód pro volání funkcí detekce tema a taktu.

    

    %TODO: Popsat princit funkce beat.beat_track ze článku Beat Tracking by Dynamic Programming (https://www.ee.columbia.edu/~dpwe/pubs/Ellis07-beattrack.pdf)
\subsection{Madmom}
\subsection{Aubio}
