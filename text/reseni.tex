...
\section{MIR - Music information retrieval} \label{sec:MIR}
    ...
    Tyto technologie se nachází v mnoha dalších aplikacích a s rozširováním digitálního audia jejich důležitost stále roste. %TODO: Citace
...
%TODO: Doplnit informace o hlasitosti v LUFS \cite{Pyloudnorm}
...
\end{equation}
  ...
  \subsection{Detekce periodicity}
    ...
    %TODO:  * popsat autokorelační funkci a její využití pro detekci tempa (periodicity) [Kdzby zbyl čas]


\section{Analýza chroma vlastností} \label{sec:Chroma_vektory}

    %TODO: Poppast deep learning systém který využívá Madmom
...
\subsection{Librosa} \label{sec:Librosa}
    ...
    %TODO: popis funkcí pro výpočet chromavektorů. 
