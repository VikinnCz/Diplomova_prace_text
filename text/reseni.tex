...
\end{figure}
 ...
 Po transformaci signálu do frekvenčního spektra jsou data signálu v komplexním tvarua a jejich magnituda $|X(f)|$ je funkce sudá, tím pádem symetrická kolem nuly a fáze $\varphi_x(f)$ je funkcí lichou čili je středově symetrická. Pro analýzu audio signálů se využívá kladná část spektra.
  ...
  %TODO: Když bude čas doplnit fungování algoritmu dle BS.1770
...
U smyčcových nástrojů takový zvuk může být ze začátku způsoben drhnutím smyčce o strunu do chvíle než se ustálí její kmitání. Délka tranzientů pak může dosahovat od jednotek milisekund až po stovky milisekund v závislosti na typu nástroje a technice hry \cite{syrový2013hudební}.
...
%TODO: Když zbude čas doplnit obrázek obálka perkusivního zvuku a táhlého
...
\section{Segmentace} \label{sec:Teorie_Segmentace}
    ...
    %TODO: Popsat aglomerative clustering použivaný funkcí librosa.segment.agglomerative
...
\cite{Music_classification_using_deep_learning}
...
\subsection{Librosa} \label{sec:Librosa}
    ...
    % TODO: Vkládat vůbec podrobný popis funkcí??? Tento text hodit do teorie detekce nástupů a zde nechat jen text o samotné knihovně. 
