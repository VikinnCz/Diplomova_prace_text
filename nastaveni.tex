...
%  [tituly před jménem]{Křestní}{Příjmení}[tituly za jménem]
% Pokud osoba nemá titul před/za jménem, smažte celý řetězec '[...]'
\advisor[Ing.]{Matěj}{Ištvánek}[Ph.d]
...
V diplomové práci je prozkoumána problematika oboru Music Information Retrieval (\acs{MIR}). Na základě získaných znalostí je navržena struktura systému pro generování animací z parametrů hudební nahrávky. Jsou porovnána dostupná řešení pro extrakci parametrů z knihoven Librosa, Madmom a Aubio. Navržená struktura je následně realizována jako funkční aplikace pomocí jazyka Python s uživatelským rozhraním ve formě webové aplikace.
}

%%% Klíčová slova
\keywrds[%
MIR, feature extraction, audio analysis, animation generator, Spectoda
]{%
MIR, extrakce parametrů, audio analýza, generátor animací, Spectoda
}

%%% Poděkování
\acknowledgement{%
Rád bych poděkoval vedoucímu diplomové práce
panu Ing. Matěji Ištvánkovi, Ph.D za odborné vedení,
