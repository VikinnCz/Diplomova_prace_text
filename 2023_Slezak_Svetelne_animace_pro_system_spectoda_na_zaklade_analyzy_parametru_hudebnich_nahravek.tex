...
\includepdf[pages=1]%  buďto generovaných informačním systémem
  {pdf/master-desky}% název souboru nesmí obsahovat mezery!
...
\includepdf[pages=1]%    buďto generovaného informačním systémem
  {pdf/master-titulka}% název souboru nesmí obsahovat mezery!
...
%% Vložení zadání
\includepdf[pages=1]%   buďto generovaného informačním systémem
  {pdf/master-zadani}% název souboru nesmí obsahovat mezery!
